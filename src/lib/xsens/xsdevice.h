...
XDA_DLL_API int XsDevice_refCounter(const struct XsDevice* thisPtr);//!< \copydoc XsDevice::refCounter() const 
...
XDA_DLL_API int XsDevice_isInSyncBoxMode(struct XsDevice* thisPtr);//!< \copydoc XsDevice::isInSyncBoxMode() 
XDA_DLL_API int XsDevice_setSyncBoxMode(struct XsDevice* thisPtr, int enabled);//!< \copydoc XsDevice::setSyncBoxMode(bool) 
...
struct XsDevice {
	...
	inline int refCounter(void) const
	{
	...
	inline bool isInSyncBoxMode(void)
	{
		return 0 != XsDevice_isInSyncBoxMode(this);
	}

	inline bool setSyncBoxMode(bool enabled)
	{
		return 0 != XsDevice_setSyncBoxMode(this, enabled);
	}
